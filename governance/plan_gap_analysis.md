...
1. **治理层缺失**
   - 缺 `governance/TODO.md`、`governance/issues_log.md`、`governance/knowledge_governance.md`
2. **轻量 RAG 交付不完整**
   - 缺 `indexes/chunk_schema.md`
   - 缺显式的 `governance/rag_regression.md`
3. **MCP 稳定性保障不完整**
   - 缺 `mcp_regression_suite.md/json`
   - 缺 `governance/mcp_observability.md`
...
- 新建 `governance/TODO.md`、`governance/issues_log.md`、`governance/knowledge_governance.md`
- 新建 `governance/mcp_regression_suite.md/json`、`governance/mcp_observability.md`、`run_mcp_regression.py`
- 新建 `indexes/chunk_schema.md`、`governance/rag_regression.md`

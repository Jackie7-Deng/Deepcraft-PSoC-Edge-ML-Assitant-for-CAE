---
title: Anomaly Detection for Vibrating Machinery
category: machine-learning
subcategory: starter-model
target_hardware: PSoC 6 AI Evaluation Kit (CY8CKIT-062S2-AI)
sensor: IMU (vibration)
task_type: binary-classification
github_repo: N/A (Starter Model)
modustoolbox_version: N/A
tags: [ml, anomaly-detection, vibration, imu, classification, deepcraft-studio]
summary: |
  异常振动检测启动模型项目。基于 IMU 传感器数据，使用二分类方法监测机械设备的正常运行与异常状态。
  包含 GraphUX 数据采集项目、自动标注脚本、预配置的预处理器和模型架构。
  适用于工业设备和消费电子的预测性维护场景。
---

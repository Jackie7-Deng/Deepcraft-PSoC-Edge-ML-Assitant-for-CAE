---
title: PSoC Edge MCU - Waveshare 4.3 inch DSI Display Driver
category: driver
subcategory: display
target_hardware: PSoC Edge E8x Kits
display: Waveshare 4.3-inch DSI Capacitive Touch Display
interface: MIPI DSI + I2C
resolution: 800x480 (recommended 832x480 for stride alignment)
library_name: display-dsi-waveshare-4-3-lcd
features:
  - Brightness control via I2C
  - MIPI DSI video mode
  - Touch panel support
tags: [driver, display, dsi, waveshare, i2c, graphics]
summary: |
  Waveshare 4.3 英寸 DSI 显示屏驱动库。支持 MIPI DSI 接口和电容触摸。
  通过 I2C 控制亮度，提供初始化、亮度设置、反初始化等 API。
  需配合 Device Configurator 配置 SCB I2C 和 Graphics 资源。
---

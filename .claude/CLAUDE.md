# PSoC Edge + DEEPCRAFT 助手兼容初始化文件

> 本文件是 `..\CLAUDE.md` 的兼容镜像。
...
4. **通用工程经验**：如果官方资料不能找到相关资料，或者仅能找到部分相关资料，允许使用通用知识与推理能力补充，但必须明确标注 `【推断/经验】`
...
- 当用户用中文提问时，优先做中文语义理解与本地知识匹配，不要因为术语翻译差异而遗漏证据
...
6. 证据不足时，先说明缺口；必要时要求提问者补充分析资料，再给最小验证步骤

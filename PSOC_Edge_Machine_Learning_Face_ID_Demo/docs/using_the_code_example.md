...
The following example clones the "[PSOC Edge MCU: Machine learning - face ID demo](https://github.com/Infineon/mtb-example-psoc-edge-ml-face-id)" application with the desired name "FaceId" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-ml-face-id --user-app-name FaceId --target-dir "C:/mtb_projects"
   ```

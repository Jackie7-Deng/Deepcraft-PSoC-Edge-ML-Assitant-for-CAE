---
source_url: "https://developer.imagimob.com/deepcraft-studio/data-preparation/data-collection/collect-data-infineon-boards/data-collection-ai-kit/data-collection-multiple-sensors"
fetched_at: "2026-03-10T15:51:33Z"
...
2. - Navigate to the **Node Explorer** window, expand **Boards> PSoC 6 AI (CY8CKIT-062S2-AI)** and drag and drop the **IMU** sensor onto the canvas. Click on the IMU sensor node and set the frequency, accel range, gyro range and mode in the Properties window. In this example, we want to collect data from both accelerometer and magnetometer, so select the mode option as combined. To know more, refer to [Setting up the IMU Sensor](https://developer.imagimob.com/data-preparation/data-collection/data-collection-using-new-streaming-firmware/data-collection-imu#setting-up-the-imu-sensor)
3. - Navigate to the **Node Explorer** window, expand **Boards> PSoC 6 AI (CY8CKIT-062S2-AI)** and drag and drop the **Magnetometer** sensor onto the canvas. Click on the Magnetometer sensor node and set the frequency in the Properties window.
4. - Navigate to the **Node Explorer** window, expand **Library> Math> Slicing and Shaping** and drag and drop the **Reshape** onto the canvas. Click on the red icon in the **Magnetometer** node and drag over to connect the Input connector in the **Reshape** node. This creates a connection between the two nodes.
  ...
  ![](https://developer.imagimob.com/Images/ai-kit/img-20.png)
